...
- RailFlip Lite turns the user's request into a directly usable game workflow. The first experience must be the actual browser game behavior, not a marketing landing page or placeholder demo.
- - FR-001: Build a compact browser-game called RailFlip Lite. It should be a full-viewport timing puzzle where the player flips a glowing marker between rails, collects blue pulses, avoids red blockers, has a settings overlay, pause/resume, score, level, and clear keyboard/click controls. Keep it small but fully playab…
...
- Gameplay - RailFlip Lite
- Game Settings - RailFlip Lite

## SCREEN_SPECS
SCREEN_SPEC_1:
- exact_screen_title: Gameplay - RailFlip Lite
...
SCREEN_SPEC_2:
- exact_screen_title: Game Settings - RailFlip Lite

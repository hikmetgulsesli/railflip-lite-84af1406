...
export type GameplayRailflipLiteActionId = "pause-game-1" | "restart-game-2" | "settings-3" | "start-game-4";

export interface GameplayRailflipLiteProps {
  actions?: Partial<Record<GameplayRailflipLiteActionId, () => void>>;
...
export function GameplayRailflipLite({ actions, runtime }: GameplayRailflipLiteProps) {
  void runtime;
  return (
    <>
      ...
      <h2 className="font-display-lg text-display-lg text-primary-container drop-shadow-[0_0_20px_rgba(0,242,255,0.6)] mb-8 text-center italic">
                  READY TO FLIP?
              </h2>
